...
class WC_Widget_Filter extends WC_Widget {

    /**
     * Constructor.
     */
    public function __construct() {
        $this->widget_cssclass    = 'woocommerce widget_filter';
        $this->widget_description = __( 'Viewing product categories.', 'woocommerce' );
        $this->widget_id          = 'woocommerce_filter';
        $this->widget_name        = __( 'WooCommerce Filter', 'woocommerce' );
        $this->settings           = array(
            'title'  => array(
                'type'  => 'text',
                'std'   => __( 'Filter by categories', 'woocommerce' ),
